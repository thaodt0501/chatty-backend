...
describe('SignUp', () => {
  ...
  it('should throw error if username is not avalaible', () => {
  ...
  it('should throw error if username is less than minimum length', () => {
    const req: Request = authMockRequest({}, {
      username: 'ma',
      email: 'tda@test.com',
      password: 'thao@123',
  ...
  it('should throw error if username is greater than maximum length', () => {
    const req: Request = authMockRequest({}, {
